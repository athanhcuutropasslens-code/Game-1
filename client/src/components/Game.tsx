...
function Game() {
  ...
  const enterRoom = useCallback((r) => {
    ...
    if (['COMBAT', 'ELITE', 'BOSS'].includes(r.type)) { setMonster(generateMonster({ floor, roomType: r.type, zoneData: zone, applyStatusEffect, randomId })); setDiceResult(null); setGameState(GAME_STATE.COMBAT); }
