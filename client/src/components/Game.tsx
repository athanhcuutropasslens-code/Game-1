...
function Game() {
  ...
  const useConsumable = useCallback(
      ...
      setPlayer((prev) => {
        ...
        switch (item.useAction) {
          case "HEAL":
            nextPlayer = {
              ...prev,
              hp: Math.min(currentRealStats.maxHp, prev.hp + value),
            };
            break;
          case "RESET_POINTS":
            nextPlayer = resetPoints(prev);
            break;
          case "APPLY_STRONG_ATK":
            nextPlayer = applyStatusEffect(prev, "STRONG_ATK", 3, value);
            break;
          case "APPLY_SHIELD":
            nextPlayer = applyStatusEffect(prev, "SHIELD", 99, value);
            break;
          default:
            return prev;
        }
    ...
    [player.classId, currentRealStats.maxHp, addLog, addEffect],
  );
